...
struct CreatePrivateCup: View {
    @Environment(\.dismiss) private var dismiss
    @ObservedObject var viewModel = PrivateCupViewModel()
...
//            }
    ...
    private func createCup() {
        ...
        guard let parsedTeams = teamsMapping[numberOfTeams],
              ...
              let _ = Auth.auth().currentUser?.displayName ,
        ...
        viewModel.createCup(
            ...
            userViewModel.addCup(cupId: newCupId)
        }
